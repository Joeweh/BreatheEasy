...
class _DirectionPageState extends State<DirectionPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          locationField(context, startQuery, setStartQuery),
          SizedBox(height: MediaQuery.of(context).size.height * .025),
          locationField(context, endQuery, setEndQuery)
        ],
      ),
    );
  }
  ...
  TextField locationField(BuildContext context, MapEntry<String, String> location, Function(MapEntry<String, String>) m) {
    return TextField(
          onTap: () {
            Navigator.push(
              context,
